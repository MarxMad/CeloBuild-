...
export function Instructions() {
  const steps = [
    {
      icon: Search,
      title: "1. Detección de Tendencia",
      description: "El agente 'TrendWatcher' escanea Farcaster en busca de conversaciones virales con alto engagement.",
    },
    {
      icon: CheckCircle2,
      title: "2. Verificación de Elegibilidad",
      description: "El agente 'Eligibility' filtra usuarios (no bots) y verifica reputación on-chain para evitar abusos.",
    },
    {
      icon: Gift,
      title: "3. Distribución Automática",
      description: "El agente 'RewardDistributor' mintea un NFT o envía cUSD directamente a la wallet MiniPay del usuario.",
    },
  ];
