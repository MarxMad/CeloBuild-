...
export const dictionary = {
    es: {
        ...
        cast_published_success: "¡Cast publicado exitosamente! Ganaste 25 XP",
        cast_success_note: "Se abrió Warpcast para que publiques el cast. Recibirás 25 XP al publicar.",
        cast_view_tx: "Ver transacción en CeloScan",
        cast_price: "Precio: 0.5 CELO",
        ...
        cast_confirm_message: "Vas a pagar 0.5 CELO para publicar este cast en Farcaster.",
        cast_confirm_message_generate: "Vas a pagar 0.5 CELO para generar este cast con IA.",
        cast_confirm_details: "Después de generar, podrás publicarlo en Farcaster y recibirás 25 XP como recompensa.",
    ...
    en: {
        ...
        cast_published_success: "Cast published successfully! You earned 25 XP",
        cast_success_note: "Warpcast was opened for you to publish the cast. You will receive 25 XP when you publish.",
        cast_view_tx: "View transaction on CeloScan",
        cast_price: "Price: 0.5 CELO",
        ...
        cast_confirm_message: "You are about to pay 0.5 CELO to publish this cast on Farcaster.",
        cast_confirm_message_generate: "You are about to pay 0.5 CELO to generate this cast with AI.",
        cast_confirm_details: "After generating, you can publish it on Farcaster and receive 25 XP as a reward.",
